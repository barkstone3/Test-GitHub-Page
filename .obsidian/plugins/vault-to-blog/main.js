...
var VaultToBlog = class extends import_obsidian7.Plugin {
  async onload() {
  ...
  async checkVersion() {
    if (this.settings.version !== this.manifest.version) {
      if (this.settings.isActivated) {
        new import_obsidian7.Notice("VTB plugin is deactivated due to detection of changing version. Please reactivate.", 5e3);
  ...
  async doDeactivate() {
    ...
    await this.renderStatusBar();
    new import_obsidian7.Notice("Deactivate Succeed.", noticeDuration);
  }
  async saveSettings() {
  ...
  async publishBlog() {
    new import_obsidian7.Notice("Start publishing blog");
    const options = { cwd: this.paths.reactPath() };
    const noticeDuration = 5e3;
    ...
    this.gitUtils.pushToRemote(options, noticeDuration).then(() => {
      new import_obsidian7.Notice("Blog published");
    });
  }
  async loadUtils() {
